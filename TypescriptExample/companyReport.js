    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client.Companies.queryCompanies("companyName startswith 'a' OR companyName startswith 'b'", "Invoices", "ASC", 100, 0)];
                case 1:
                    companies = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, client.Companies.queryCompanies("companyName startswith 'a' OR companyName startswith 'b'", "Invoices", "ASC", 100, pageNumbers)];
                case 5:
                    companies = _a.sent();
                    if (!companies.success || companies.value.records.length == 0) {
                        return [3 /*break*/, 6];
                    }
                    companies.value.records.forEach(function (company) {
